		...
		attributes: [
			{
				...
				css: [],
				enableAnnouncement: __(
					"Enable Screen Reader, set to Normal.",
					"website-accessibility",
				),
			},
			{
