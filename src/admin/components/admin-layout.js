				...
				<Sider width={280} className="wap-admin-sider" theme="light">
					...
					{typeof window !== 'undefined' && window.websacAdmin?.isProPluginActive && !window.websacAdmin?.isLicenseValid && (
						<div className="wap-admin-license-card wap-admin-license-card--required">
							...
							<div className="wap-admin-license-card__body">
								<div className="wap-admin-license-card__lock" aria-hidden="true">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 24 24"
										width="28"
								...
								<div className="wap-admin-license-card__title">
									{__('One Accessibility', 'website-accessibility')}
								</div>
								<div className="wap-admin-license-card__subtitle">
									{__('✨ All premium features will be unlocked after activating license!', 'website-accessibility')}
								</div>
								<a
									href={window.websacAdmin?.licensePageUrl || '#'}
									className="wap-admin-license-card__btn"
								>
					...
					{typeof window !== 'undefined' && window.websacAdmin?.isLicenseValid && (
						<div className="wap-admin-pro-card">
							...
							<div className="wap-admin-pro-card__body">
								<div className="wap-admin-pro-card__check" aria-hidden="true">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 24 24"
										width="28"
								...
								<div className="wap-admin-pro-card__title">
									{__('One Accessibility', 'website-accessibility')}
								</div>
								<div className="wap-admin-pro-card__subtitle">
									{__('✨ All premium features unlocked!', 'website-accessibility')}
								</div>
							</div>
						</div>
					)}
