					...
					{typeof window !== 'undefined' && !window.websacAdmin?.whiteLabelFooterHidden ? (
						<>
							...
							<span className="wap-admin-footer__heart" aria-hidden="true">
								{/* An inline SVG rather than the heart emoji: emoji render
								    from a font, so they fall back to a hollow glyph, a
								    monochrome outline or a tofu box depending on the OS
								    and the admin's font stack. */}
