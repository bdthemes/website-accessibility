...
- **PHP filters added 1.5.2:** `websac_usage_statistics_features` (tracked feature keys), `websac_feature_category_definitions` (category placement used by migrations), `websac_default_preset_content` (activation seed).
