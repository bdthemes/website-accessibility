...
/**
 * Biggopti class - Admin messaging system for One Accessibility
 */
class Biggopti {
	...
	public function __construct() {
		...
		add_action('wp_ajax_one_accessibility_biggoptis', [$this, 'dismiss']);

		// AJAX endpoint to fetch API biggoptis on demand (after page load)
		add_action('wp_ajax_oa_fetch_api_biggoptis', [$this, 'ajax_fetch_api_biggoptis']);
	...
	private function get_current_plugin_slug() {
		...
		$plugin_file = plugin_basename(WEBSAC_DIR . 'website-accessibility.php');
	...
	public function show_biggoptis() {
		...
		$defaults = [
			...
			'title'            => '',
			'message'          => '',
			'class'            => 'one-accessibility-biggopti',
			'dismissible'      => false,
			'dismissible-meta' => 'transient',
